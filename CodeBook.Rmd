...
#### Variables: The following Variables are part of the Tidy_Data file

The "subjectId" is the unique identifier for each individual

The "activityId" signifies the type of activity being measured (Walking, going_downstairs, going_upstairs, sitting, laying).

Each variable is provided in both mean and standard deviation forms.
